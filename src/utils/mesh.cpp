...
Mesh Mesh::GetQuadMesh(){
    ...
    mesh.vertices = std::vector<Vertex>{
        {glm::vec3(-1.0f, -1.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0, 1)},
        {glm::vec3( 1.0f, -1.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(1, 1)},
        {glm::vec3( -1.0f,  1.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(0, 0)},
        {glm::vec3( 1.0f,  1.0f, 0.0), glm::vec3(0.0f, 0.0f, 1.0f), glm::vec2(1, 0)},
    };
